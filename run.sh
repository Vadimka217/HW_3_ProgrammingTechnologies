...
case "$1" in
    ...
    *)
        echo "Команда не найдена. Используйте: build_generator, run_generator, create_local_data, build_reporter, run_reporter, structure, clear_data, inside_generator, inside_reporter"
        exit 1
        ;;
esac